  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'accountCreationTitle', type: 'text', label: 'Titre création de compte', defaultValue: 'Crée ton compte Dague de Cœur' },
        { name: 'accountCreationText', type: 'text', label: 'Texte création de compte', defaultValue: 'Accède à du contenu exclusif, sauvegarde tes préférences et rejoins la communauté.' },
        { name: 'accountCreationCta', type: 'text', label: 'CTA création de compte', defaultValue: 'CRÉER MON COMPTE GRATUITEMENT ⚔️' },
        { name: 'accountCreationLink', type: 'text', label: 'Lien création de compte', defaultValue: '/signup' },
